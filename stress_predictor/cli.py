...
def get_args():
    ...
    parser.add_argument("--model", type=str, required=True, help="Hugging Face model name, choose between dnabert or mistral-athaliana")
    parser.add_argument("--tokenizer", type=str, required=True, help="Hugging Face tokenizer name, choose between dnabert or mistral-athaliana")
    ...
    parser.add_argument("--stride", type=int, help=("Stride size (only for --pr)"
                                                    ...
                                                    "Default: 200."))
    parser.add_argument("--output", type=str, help=("Output folder (mode-dependent default)."
                                                    "Default: outputs_rg or outputs_pr"))
    ...
    if args.pr:
        ...
        if args.output is None:
            args.output = "outputs_pr"
    elif args.rg:
        if args.output is None:
            args.output = "outputs_rg"
